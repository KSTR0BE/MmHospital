...
<%
	DoctorVO dvs = (DoctorVO)request.getAttribute("DOC");
%>
<!DOCTYPE html>
<html>
<head>
...
%>
	...
	<div class="container">
		<form class="form-signin" method="post"
			action="<%=request.getContextPath()%>/docpwCheck.do">
			<br>
			<br>
			<br>
			<br>
			...
			<p>
				...
				<input type="hidden" id="memId" name="memId" class= "form-control" value="<%=dv.getDt_id()%>">
				<input
