...
<body>
	...
	<div id="mypage">
		...
		<div id="modify">
			<form method="post" id="modForm">
				<input type="hidden" id="id" name="uId" value="<%=nsv.getNs_id()%>">
				<input type="hidden" id="name" name="name" value="<%=nsv.getNs_nm()%>">
				<div id="tbtb">
					<table>
						<tr>
							<td>I D:</td>
						...
						<tr>
							<td>이메일 * :</td>
							<td><input type="text" id="ns_mail" name="ns_mail"
								value="<%=nsv.getNs_em()%>" required
								style="width: 200px; height: 30px;"></td>
						</tr>
	...
	<script type="text/javascript">
		$('#ListBtn').on('click',function(){
			location.href="<%=request.getContextPath()%>/nurMypage.do";
		});
