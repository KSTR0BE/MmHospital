...
<%
	NurseVO ns = (NurseVO)request.getAttribute("NUR");
%>
<!DOCTYPE html>
<html>
<head>
...
%>
	...
	<div class="container">
		<form class="form-signin" method="post"
			action="<%=request.getContextPath()%>/nurpwCheck.do">
			<br>
			<br>
			<br>
			<br>
			...
			<p>
				...
				<input type="hidden" id="memId" name="memId" class= "form-control" value="<%=nsv.getNs_id()%>">
				<input
