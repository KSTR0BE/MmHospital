...
<link rel="stylesheet" type="text/css" href="../resources/dist/css/sub.css">
 ...
 <p><img src="<%=request.getContextPath() %>/resources/dist/images/sub/sub1/res.jpg"/></p>		 </div>
			 ...
			 <div class="sub_content">
				<div class="sub1_2">
					<ul class="tabmenu_202303">
						...
						<li class="on"><a href="sub_1_2_3.jsp">비뇨기과</a></li>
		...
		<li class='item'>
			<div class='photo'><img src='<%=request.getContextPath() %>/resources/dist/photo/이성훈.png' alt='이성훈'></div>
			<div class='detail'>
				<div class='txt1'>비뇨기과</div>
				<div class='txt2'>이성훈 <span>의사</span></div>
							<ul class='btn'>
								<!--<li><a href='javascript:reservationPop.open();' class='btn2'>예약하기</a></li>-->
							</ul>
							<dl class='txt3'>
								<dt>전문진료분야</dt>
								<dd>신장 (콩팥), 요관, 방광, 요도 등 요로계 장기들에 발생하는 질환들과 음경, 고환, 정관 및 전립선 등 남성생식과 관련된 질환</dd>
								<dd>
