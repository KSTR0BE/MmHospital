...
<link rel="stylesheet" type="text/css" href="../resources/dist/css/sub.css">
 ...
 <p><img src="<%=request.getContextPath() %>/resources/dist/images/sub/sub1/res.jpg"/></p>		 </div>
			 ...
			 <div class="sub_content">
				<div class="sub1_2">
					<ul class="tabmenu_202303">
						...
						<li class="on"><a href="sub_1_2_4.jsp">신경과</a></li>
		...
		<li class='item'>
			<div class='photo'><img src='<%=request.getContextPath() %>/resources/dist/photo/김성도.png' alt='김성도'></div>
			<div class='detail'>
				<div class='txt1'>신경과</div>
				<div class='txt2'>김성도 <span>의사</span></div>
							<ul class='btn'>
								<!--<li><a href='javascript:reservationPop.open();' class='btn2'>예약하기</a></li>-->
							</ul>
							<dl class='txt3'>
								<dt>전문진료분야</dt>
								<dd>뇌졸중 및 뇌혈관 질환, 뇌전증(간질) 및 수면장애, 파킨슨 증후군 및 이상운동질환, 근신경계 질환, 탈수초성 질환, 치매 및 기타 인지장애, 난치성 두통, 신경통, 자가면역뇌염 및 신경계 감염증 </dd>
								<dd>
		...
		<li class='item'>
			<div class='photo'><img src='<%=request.getContextPath() %>/resources/dist/photo/최병관.png' alt='최병관'></div>
			<div class='detail'>
				<div class='txt1'>신경과</div>
				<div class='txt2'>최병관 <span>의사</span></div>
							<ul class='btn'>
								<!--<li><a href='javascript:reservationPop.open();' class='btn2'>예약하기</a></li>-->
							</ul>
							<dl class='txt3'>
