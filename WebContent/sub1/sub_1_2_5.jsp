...
<link rel="stylesheet" type="text/css" href="../resources/dist/css/sub.css">
 ...
 <p><img src="<%=request.getContextPath() %>/resources/dist/images/sub/sub1/res.jpg"/></p>		 </div>
			 ...
			 <div class="sub_content">
				<div class="sub1_2">
					<ul class="tabmenu_202303">
						...
						<li class="on"><a href="sub_1_2_5.jsp">정신과</a></li>
					</ul>
		...
		<li class='item'>
			<div class='photo'><img src='<%=request.getContextPath() %>/resources/dist/photo/주현주.png' alt='주현주'></div>
			<div class='detail'>
				<div class='txt1'>정신과</div>
				<div class='txt2'>주현주 <span>의사</span></div>
							<ul class='btn'>
								<!--<li><a href='javascript:reservationPop.open();' class='btn2'>예약하기</a></li>-->
							</ul>
							<dl class='txt3'>
								<dt>전문진료분야</dt>
								<dd>조현병, 우울증, 조울증, 불면증, 불안장애, 성격장애, 지적장애, 성인발달장애</dd>
								<dd>
