<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	String sgNo = (String)request.getAttribute("sgNo");
%>
<!doctype html>
<html lang="ko">
...
<link rel="stylesheet" type="text/css" href="/MmHospital/resources/dist/css/sub.css">
 ...
 <p><img src="/MmHospital/resources/dist/images/sub/sub1/res.jpg"/></p>		 </div>
		 ...
		 <div class="right">
			...
			<form action="<%=request.getContextPath()%>/commentt/insert.do" method="post">
				...
				<div class="table_default">
							...
							<table>
								...
								<thead>
									...
									<tr>
										<th scope="col">답변</th>
										<td colspan="5"><textarea type="text" name="cmCon" class="form-control" style="width:99%; height:200px"></textarea></td>
									</tr>
									...
									<tr>
										...
										<td></td>
										<td></td>
										<td>&emsp;&emsp;&emsp;&emsp;<button type="submit" class="button" style="width:50%; height:40px; background-color:#00A796; color:white">등록</button></td>
									</tr>	
