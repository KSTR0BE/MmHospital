 ...
 <p><img src="/MmHospital/resources/dist/images/sub/sub1/res.jpg"/></p>		 </div>
			...
			<input type='hidden' name='idx' value=''>
							...
							<table>
								...
								<thead>
									...
									<tr>
										<th scope="col">제목</th>
										<td colspan="5">&emsp;<%=nv.getNtTit() %></td>
									</tr>
									...
									<tr>
										<th scope="col">내용</th>
										<td colspan="5">&emsp;<%=nv.getNtCon() %></td>
									</tr>
	...
	<script>
		...
		function confirm_btn(){
			if(confirm("삭제하시겠습니까?")){
				location.href = "<%=request.getContextPath()%>/notice/delete.do?ntNo=" + "<%=nv.getNtNo()%>";
			}
		}
		function confirm_btn1(){
			if(confirm("수정하시겠습니까?")){
				location.href = "<%=request.getContextPath()%>/notice/update.do?ntNo=" + "<%=nv.getNtNo()%>";
			}
		}
