 ...
 <p><img src="/MmHospital/resources/dist/images/sub/sub1/res.jpg"/></p>		 </div>
	...
	<script type="text/javascript">
		...
		function nosize_window2(url,win,w,h){
			...
			<form action="<%=request.getContextPath()%>/notice/insert.do" method="post" enctype="multipart/form-data">
				<input type="hidden" name="adNo" value="<%=av.getAdNo()%>">
				<input type="hidden" name="ntNm" value="관리자">
			...
			<input type='hidden' name='idx' value=''>
							...
							<table>
								...
								<thead>
									...
									<tr>
										<th scope="col">제목</th>
										<td colspan="5"><input type="text" name="ntTit" class="form-control" style="width:99%; height:35px"/></td>
									</tr>
									
									<tr>
										<th scope="col">내용</th>
										<td colspan="5"><textarea type="text" name="ntCon" class="form-control" style="width:99%; height:200px"></textarea></td>
									</tr>
									...
									<tr>
										...
										<td></td>
										<td>
										<button type="submit" class="button" style="width:40%; height:40px; background-color:#00A796; color:white">등록 </button>&nbsp;<button onclick="nt_cc()" style="width:40%; height:40px; background-color:#00A796; color:white">취소</button>
										</td>
									</tr>	
