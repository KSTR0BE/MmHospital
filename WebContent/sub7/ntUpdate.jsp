 ...
 <p><img src="/MmHospital/resources/dist/images/sub/sub1/res.jpg"/></p>		 </div>
	...
	<script type="text/javascript">
		...
		function nosize_window2(url,win,w,h){
			...
			<form action="<%=request.getContextPath()%>/notice/update.do" method="post" enctype="multipart/form-data">
			<input type="hidden" name="ntNo" value="<%=nv.getNtNo() %>">
			<input type="hidden" name="atchFileId" value="<%=nv.getAtchFileId()%>">
			...
			<input type='hidden' name='idx' value=''>
							...
							<table>
								...
								<thead>
									...
									<tr>
										<th scope="col">제목</th>
										<td colspan="5"><input type="text" name="ntTit" value="<%=nv.getNtTit() %>" class="form-control" style="width:99%; height:35px"/></td>
									</tr>
									
									<tr>
										<th scope="col">작성자</th>
										<td>&emsp;<%=nv.getNtNm() %></td>
										<th scope="col">등록일</th>
										<td>&emsp;<%=nv.getNtDt() %></td>
										<th scope="col">조회수</th>
										<td>&emsp;<%=nv.getNtHit() %></td>
									</tr>
									...
									<tr>
										<th scope="col">내용</th>
										<td colspan="5"><textarea type="text" name="ntCon" value="<%=nv.getNtCon() %>" class="form-control" style="width:99%; height:200px"><%=nv.getNtCon() %></textarea></td>
									</tr>
									<tr>
