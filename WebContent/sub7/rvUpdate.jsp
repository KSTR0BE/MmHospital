 ...
 <p><img src="/MmHospital/resources/dist/images/sub/sub1/res.jpg"/></p>		 </div>
	...
	<script type="text/javascript">
		...
		function nosize_window2(url,win,w,h){
			...
			<form action="<%=request.getContextPath()%>/review/update.do" method="post" enctype="multipart/form-data">
			...
			<input type='hidden' name='idx' value=''>
							...
							<table>
								...
								<thead>
									...
									<tr>
										<th scope="col">제목</th>
										<td colspan="5"><input type="text" name="rvTit" value="<%=rv.getRvTit() %>" class="form-control" style="width:99%; height:35px"/></td>
									</tr>
									...
									<tr>
										<th scope="col">내용</th>
										<td colspan="5"><textarea type="text" name="rvCon" value="<%=rv.getRvCon() %>" class="form-control" style="width:99%; height:200px"><%=rv.getRvCon() %></textarea></td>
									</tr>
									<tr>
