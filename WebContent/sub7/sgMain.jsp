...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	List<SuggestionsVO> sgList = (List<SuggestionsVO>)request.getAttribute("sgList");
 ...
 <p><img src="/MmHospital/resources/dist/images/sub/sub1/res.jpg"/></p>		 </div>
		 ...
		 <div class="right">
		     ...
		     <div class="sub_content">
				...
				<form action="<%=request.getContextPath()%>/suggestions.do" method="get">
						...
						<div class="board_search">
							<table>
								...
								<thead>
									...
									<tr>
										<th scope="col">제목</th>
										<td><input type="text" name="sgTit" class="form-control" style="width:90%"/></td>
					...
					<div class="table_default">
							...
							<table>
								...
								%>
									<tr align="center" height="27">
									  <td><%=str + i %></td>
									  <td><a href="<%=request.getContextPath() %>/suggestions/detail.do?sgNo=<%=sgList.get(i).getSgNo() %>"><%=sgList.get(i).getSgTit() %></a></td>
									  <td><%=sgList.get(i).getSgDt() %></td>
									  <td><%=sgList.get(i).getSgHit() %></td>
								 </tr>
								<%			
										}
								%>
							...
							<ul class="btns">
								<li>
									<a href="<%=request.getContextPath() %>/suggestions/insert.do" class="btn_green">등록</a>
								</li>
							</ul>
							<%
								}
...
<script>
		...
		$('.pagination li').on('click',function(){
			location.href = "<%=request.getContextPath()%>/suggestions.do?page=" + $(this).text();
		});
		...
		//		alert($('.pagination').children().last() .text());
			...
			location.href = "<%=request.getContextPath()%>/suggestions.do?page=" + page;
