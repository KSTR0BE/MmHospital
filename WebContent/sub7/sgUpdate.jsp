 ...
 <p><img src="/MmHospital/resources/dist/images/sub/sub1/res.jpg"/></p>		 </div>
	...
	<script type="text/javascript">
		...
		function nosize_window2(url,win,w,h){
			...
			<form action="<%=request.getContextPath()%>/suggestions/update.do" method="post" enctype="multipart/form-data">
			<input type="hidden" name="sgNo" value="<%=sv.getSgNo() %>">
			...
			<input type='hidden' name='idx' value=''>
							...
							<table>
								...
								<thead>
									...
									<tr>
										<th scope="col">제목</th>
										<td colspan="5"><input type="text" name="sgTit" value="<%=sv.getSgTit() %>" class="form-control" style="width:99%; height:35px"/></td>
									</tr>
									...
									<tr>
										<th scope="col">내용</th>
										<td colspan="5"><textarea type="text" name="sgCon" value="<%=sv.getSgCon() %>" class="form-control" style="width:99%; height:200px"><%=sv.getSgCon() %></textarea></td>
									</tr>
