						...
						<div class="table_default">
							<table>
								...
								<tbody>
									<tr>
										<th scope="col">제목</th>
										<td class="t_left" colspan="5">요추추간판탈출증(허리디스크)</td>
									</tr>
									<tr>
										<th scope="col">작성자</th>
										<td class="t_left">관리자</td>
										<th scope="col">등록일</th>
										<td>2021.01.05</td>
										<th scope="col">조회수</th>
										<td>0</td>
									...
									<tr>
										...
										<td class="t_left" colspan="5"></td>
									</tr>
									<tr>
										<th scope="col">내용</th>
										<td class="t_left" colspan="5">
																						<iframe width="800" height="450" src="https://www.youtube.com/embed/BWzJRlYRSYY" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>										</td>
									</tr>
								</tbody>
							</table>
							<ul class="btns">
								<li><a href="sub_7_46bd1.html?db=ds8_1_1&amp;c=list&amp;page=1&amp;kind3=&amp;SK=&amp;SN=&amp;idx=" class="btn_green">목록</a></li>
							</ul>
						</div>
...
<!-- Mirrored from djtntn.com/sub/sub7/sub_7_4.php?db=ds8_1_1&no=44&c=view&page=1&SK=&SN=&idx= by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 May 2024 01:56:23 GMT -->
</html>	