...
public class ReviewMain extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String rvTit = request.getParameter("rvTit") == null ? 
				"" : request.getParameter("rvTit");
...
//		int totalCount = rvService.countList(); // 총 게시글 갯수
		int totalCount = rvService.countList2(rvTit); // 총 게시글 갯수
//		
//		// 화면에 표시될 페이지 수
		int perPage = 5;
//		
...
//		
//		// 게시글 조회
		List<ReviewVO> rvList = rvService.rvList(map);
		...
		request.getRequestDispatcher("/sub7/rvMain.jsp").forward(request, response);
	}
