...
@MultipartConfig
@WebServlet("/suggestions/insertd.do")
public class SuggestionsInsertD extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		SuggestionsVO sv = new SuggestionsVO();
		
		sv.SuggestionsVO1(sgTit, sgCon, dtNo, sgNm);
		
		if(atchFileVO != null) {
			sv.setAtchFileId(atchFileVO.getAtchFileId());
		}
		
		int cnt = sgService.sgInsertD(sv);
